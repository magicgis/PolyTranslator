...
echo ============================================
echo   lang-generator Publisher
echo ============================================
echo.

set "CARGO_TOML=%~dp0lang-generator\Cargo.toml"
...
echo lang-generator version: %CURRENT_VERSION%
echo.

findstr /c:"publish = false" "%CARGO_TOML%" >nul
if !errorlevel! equ 0 (
    echo WARNING: Found publish = false in lang-generator/Cargo.toml
...
echo   - lang-generator v%CURRENT_VERSION%
echo.
...
echo.
echo 4. Publishing lang-generator v%CURRENT_VERSION%...
...
if "!NEED_RESTORE!"=="true" (
    del "%~dp0lang-generator\Cargo.toml.backup" >nul 2>&1
)
